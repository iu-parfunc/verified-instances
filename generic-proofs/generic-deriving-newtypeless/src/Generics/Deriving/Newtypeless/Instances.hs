...
module Generics.Deriving.Newtypeless.Instances () where

import Generics.Deriving.Newtypeless.TH

$(deriveAll0     ''Bool)
$(deriveAll0And1 ''[])
$(deriveAll0And1 ''Maybe)

{-
-- Only instances from Generics.Deriving.Newtypeless.Base
...
instance Datatype D1ConSum where
    datatypeName _ = ":+:"
    moduleName   _ = "Generics.Deriving.Newtypeless.Base.Internal"
